...
@section('header')
    @csrf
    <link href="assets/ltr/plugins/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css" rel="stylesheet">
@endsection
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="customer_type_id" class="form-control">
                                        ...
                                        <option value="{{$customer_type->id}}">{{$customer_type->default_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
{{--                                        @endforeach--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="payment_expire_date" class="form-control" value="2021-03-04 09:14:48">
                                </div>
                                <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary waves-effect w-md waves-light m-b-5">submit</button>
                        </form>
...
@endsection
@section('footer')
    <script src="assets/ltr/plugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
@endsection
@section('script')
    <script>
